...
약 15장 분량을 기준으로 초안 제작에는 약 10분, 정밀 검증에는 약 40~50분이 걸립니다. 이는 **GPT-5.6, 추론 강도 Medium**과 렌더링 도구가 이미 설치된 환경을 기준으로 한 대략적인 시간이며, 자료 조사·이미지 생성·출처 검증 범위에 따라 달라질 수 있습니다.
