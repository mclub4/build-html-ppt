...
약 15장 분량을 기준으로 초안 제작에는 약 10분, 정밀 검증에는 약 40~50분이 걸립니다. 이 수치는 **Codex GPT-5.6, 추론 강도 Medium**과 렌더링 도구가 이미 설치된 환경에서 측정한 대략적인 기준이며, Claude Code에서는 선택한 모델과 effort에 따라 달라질 수 있습니다. 팬아트·이미지 대량 요청은 보통 90~120분을 목표로 진행하지만 이는 강제 상한이 아닙니다. 두 시간을 넘길 가능성이 크면 현재 후보로 마무리할지 탐색을 계속할지 사용자에게 확인합니다.
...
<table>
  ...
  <tr>
    <td width="33.33%">
      <img src="assets/showcase/bluearchive-nong.webp" alt="블루 아카이브 팬 문화와 캐릭터 큐레이션 표지 슬라이드" />
      <br /><strong>게임 팬 문화 · 캐릭터 큐레이션</strong>
    </td>
    <td width="33.33%">
