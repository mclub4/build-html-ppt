...
- Signature slides: thesis poster, data strip, annotated matrix, full-width timeline
- Avoid: tiny all-caps everywhere and sterile empty space with no evidence
...
- Signature slides: cover story, profile split, contact-sheet gallery, quote interlude
- Avoid: imitating a specific magazine masthead or covering images with long paragraphs
...
- Signature slides: key-visual cover, scene-led premise, mood montage, recommendation/trigger warning, cinematic closing
- Avoid: cropping title art, logos, faces, or edge-important key visuals
...
- Signature slides: system context, closed loop, failure choreography, authority ladder, deployment roadmap
- Avoid: neon decoration without hierarchy or one enormous unreadable architecture diagram
...
- Signature slides: logo/product cover, hero feature, proof metric, lineup, price or availability, lifestyle payoff
- Avoid: homemade logos, fake product renders, and feature-card walls
...
- Signature slides: magazine cover, destination opener, 24/48/72-hour itinerary, neighborhood or food lineup, route map, practical-info spread, final recommendation
- Avoid: copied mastheads, field-research specimen labels, fake taped notes, repetitive attraction cards, empty photo frames, generic travel icons in place of destination imagery, and treating a leisure guide like a research report
...
- Signature slides: place-setting cover, field observation, annotated image, route/process, lessons learned
- Avoid: fake paper clutter, beige-only palettes, decorative stickers with no informational role, and applying field-journal styling to an ordinary leisure guide
...
- Signature slides: question opener, step sequence, choose-a-path, simple comparison, recap board
- Avoid: childish decoration for adult audiences and identical rounded cards on every slide
...
- Signature slides: sensory cover, moment sequence, testimonial, service journey, human closing
- Avoid: low-contrast pastel text and decorative blur blobs
...
- Signature slides: signal cover, system boot sequence, feature module, lineup, countdown, end card
- Avoid: illegible pixel body text, excessive glow, and novelty effects on factual slides
...
- Signature slides: manifesto cover, problem statement, action sequence, commitment board
- Avoid: political-historical imitation that confuses the message or aggressive styling without substance
...
- Signature slides: object cover, detail study, provenance timeline, comparative plate, reflection closing
- Avoid: luxury cliches, gold gradients, and tiny metadata that cannot be read in a room
...
- Signature slides: blunt thesis cover, numbered evidence stack, hard-split comparison, oversized decision, stamped closing
- Avoid: random misalignment, inaccessible color collisions, fake browser chrome, and making every element loud at once
...
- Signature slides: poster cover, cut-and-paste manifesto, contact sheet, annotated artifact, foldout-style timeline
- Avoid: unreadable distress on body text, fake paper clutter, copied magazine identities, and decorative scraps with no narrative role
...
- Signature slides: system elevation, exploded view, interface detail, assembly flow, revision comparison, commissioning checklist
- Avoid: ornamental grid noise, dimensions without units, impossible geometry, and one dense drawing that must be zoomed to understand
...
- Signature slides: establishing image, witness quote, three-frame sequence, place map, evidence detail, reflective closing
- Avoid: stock-photo ambiguity, sensational crops, captions that imply unsupported facts, and using vulnerable people as decoration
...
- Signature slides: spatial hero, layered capability reveal, environment map, state transition, interaction detail, future-state closing
- Avoid: decorative blur blobs, low-contrast glass text, unsupported hologram cliches, and depth effects that obscure hierarchy
