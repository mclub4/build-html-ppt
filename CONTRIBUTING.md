...
1. Keep the shared skill under `codex/skills/build-html-slides` as the source of truth.
2. Run `./scripts/sync-distributions.sh` after changing it; the script updates the Codex plugin and Claude skill copies.
