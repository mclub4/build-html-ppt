...
6. For slide 1, apply `cover-design.md` as an additional gate. Fail a generic title-template composition, ambiguous subject identity, weak or irrelevant hero visual, oversized empty title panel, awkward title wrapping, cropped identifying feature, or cover whose first impression is visibly less resolved than the body slides. Geometry alone cannot pass the cover.
