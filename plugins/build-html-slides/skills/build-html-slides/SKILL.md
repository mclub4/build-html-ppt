...
- Treat technology as a subject domain, not a license for near-black surfaces, neon status color, mono micro-labels, glowing nodes, or diagonal control panels. Use Mission Control or Technical Night only when operations, monitoring, incidents, security, or the subject's authentic brand identity makes that grammar meaningful.
